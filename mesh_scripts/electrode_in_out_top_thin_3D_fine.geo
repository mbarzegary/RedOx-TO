...
Point(1) = {0, 0, 0, size};
Point(2) = {2.0, 0, 0, size};
Point(3) = {2.0, 2.0, 0, size};
Point(4) = {0, 2.0, 0, size};
Point(5) = {0.3, 0.3, 0, size};
Point(6) = {1.7, 0.3, 0, size};
Point(7) = {1.7, 1.7, 0, size};
Point(8) = {0.3, 1.7, 0, size};
Point(9) = {0, 0, 0.5, size};
Point(91) = {0, 0.3, 0.5, size};
Point(92) = {0.3, 0, 0.5, size};
Point(10) = {2.0, 0, 0.5, size};
Point(11) = {2.0, 2.0, 0.5, size};
Point(111) = {2.0, 1.7, 0.5, size};
Point(112) = {1.7, 2.0, 0.5, size};
Point(12) = {0, 2.0, 0.5, size};
Point(13) = {0.3, 0.3, 0.5, size};
Point(14) = {1.7, 0.3, 0.5, size};
Point(15) = {1.7, 1.7, 0.5, size};
Point(16) = {0.3, 1.7, 0.5, size};
Point(90) = {0, 0, 0.8, size};
Point(910) = {0, 0.3, 0.8, size};
Point(920) = {0.3, 0, 0.8, size};
Point(130) = {0.3, 0.3, 0.8, size};
Point(110) = {2.0, 2.0, 0.8, size};
Point(1110) = {2.0, 1.7, 0.8, size};
Point(1120) = {1.7, 2.0, 0.8, size};
Point(150) = {1.7, 1.7, 0.8, size};
